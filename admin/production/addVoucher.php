    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="form-group">
          ...
          <input required minlength="1" maxlength="50" name="start" type="date" class="form-control" id="exampleInputPassword1" placeholder="Nhập màu">
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Ngày kết thúc</label>
          <input required minlength="1" maxlength="500" name="end" type="date" class="form-control" id="exampleInputPassword1" placeholder="Nhập giới thiệu">
        </div>
...
if (isset($_POST['submit'])) {
    // ... (your existing code for form data processing)
    ...
    foreach ($_FILES['files']['name'] as $key => $value) {
        $targetFileName = uniqid() . '_' . basename($_FILES['files']['name'][$key]); // Unique file name to avoid overwriting
        $targetFilePath = $uploadDir . $targetFileName;

        // Move the uploaded file to the local directory
        move_uploaded_file($_FILES['files']['tmp_name'][$key], $targetFilePath);

        $uploadedFiles[] = $targetFileName; // Store only the file name in the database
    }

    // Chuẩn bị truy vấn SQL để chèn dữ liệu vào cơ sở dữ liệu
    $sql = "INSERT INTO voucher (`Name`, `Sale`, `start`, `end`, `image_path`) 
            VALUES ('$name', '$sale', '$start', '$end', '" . implode(",", $uploadedFiles) . "')";

    // Thực hiện truy vấn
    if (mysqli_query($conn, $sql)) {
        echo "Thêm voucher thành công";

        // // Hiển thị thông tin và ảnh voucher trong bảng
        // echo "<h2>Thông Tin Voucher:</h2>";
        // echo "<table border='1'>";
        // echo "<tr>";
        // echo "<th>Name</th>";
        // echo "<th>Sale</th>";
        ...
        //     echo "<tr>";
        //     echo "<td class='voucher-info'>$name</td>";
        //     echo "<td class='voucher-info'>$sale</td>";
        //     echo "<td class='voucher-info'>$start</td>";
        //     echo "<td class='voucher-info'>$end</td>";
        //     echo "<td class='voucher-image'><img src='$imageUrl' alt='Uploaded Image'></td>";
        //     echo "</tr>";
        // }
