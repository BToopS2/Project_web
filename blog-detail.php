...
<html lang="en">
  <head>
    ...
    <title>HUS - Tin Tức Chi Tiết</title>
    <!-- Fonts-->
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 ">
                  <div class="ps-post--detail">
                    ...
                    <div class="ps-post__header">
                      <h3 class="ps-post__title">MỞ GÓI CHIẾN LƯỢC ĐUA BREAKING2</h3>
                      <p class="ps-post__meta">Posted by <a href="blog-grid.php">TV2H_team</a> on August 17, 2023  in <a href="blog-grid.php">Men Shoes</a> , <a href="blog-grid.php">Stylish</a></p>
                    </div>
                    <div class="ps-post__content">
                      <p>Chào mừng bạn đến với Nike Breaking2 - một chiến dịch đầy thách thức và khám phá giữa niềm đam mê thể thao và khả năng vượt qua giới hạn con người. Nike Breaking2 là một sáng kiến độc đáo của hãng thể thao nổi tiếng Nike, tập trung vào việc phá vỡ rào cản về tốc độ trong môn thể thao chạy marathon.Hứa hẹn mang đến một bước tiến lớn đối với con người, Breaking2 là cuộc đua chạy marathon không giới hạn, nơi những người vận động viên tài năng nhất trên thế giới đối mặt với thách thức vượt qua giới hạn khoa học và thể chất. Chiến dịch này không chỉ là về việc chạy nhanh hơn, mà còn về việc mở đường cho sự đổi mới trong công nghệ, thiết kế và triết học thể thao.</p>
                      <blockquote>
                        <p>Breaking2 không chỉ là một cuộc đua, mà là một hành trình khám phá và đối mặt với những thách thức chưa từng có, tạo nên những câu chuyện đầy cảm hứng và ý nghĩa. Đây là một hành động quảng bá tinh thần "Just Do It" của Nike, thách thức mọi người vượt qua chính mình và chứng minh rằng giới hạn chỉ tồn tại trong tâm trí.</p>
                        <p class="author">Rodney <br> <span>Cannon</span></p>
                      </blockquote>
                      <p>Với Breaking2, Nike không chỉ là một thương hiệu thể thao, mà là một đối tác hỗ trợ vô song trong hành trình vươn tới giới hạn của con người và khám phá những khả năng mới. Chiến dịch này là biểu tượng của sức mạnh, quyết tâm và lòng kiên nhẫn, đồng thời là một bước tiến lớn trong việc định hình tương lai của thể thao đương đại.</p>
                    </div>
                    <div class="ps-post__footer">
                      <p class="ps-post__tags"><i class="fa fa-tags"></i><a href="blog-list.php">Giày Nam</a>,<a href="blog-list.php"> Nữ</a>,<a href="blog-list.php"> Nike</a></p>
                      <div class="ps-post__actions"><span><i class="fa fa-comments"></i> 23 Bình Luận</span><span><i class="fa fa-heart"></i>  likes</span>
                  ...
                  <div class="ps-author">
                    ...
                    <div class="ps-author__content">
                      <header>
                        <h4>MARK GREY</h4>
                        <p>NGƯỜI THIẾT KẾ WEB</p>
                      </header>
                      <p>Sự phát triển của máy phổ khối cho phép đo khối lượng của nguyên tử với độ chính xác tăng lên. Thiết bị sử dụng việc phóng và tiếp tục vận hành của kính viễn vọng không gian Hubble có lẽ.</p>
                    </div>
                  </div>
                  <div class="ps-comments">
                    ...
                    <div class="ps-comment">
                      ...
                      <div class="ps-comment__content">
                        <header>
                          <h4>MARK GREY <span>(15 minutes ago)</span></h4><a href="#">Trả Lời<i class="ps-icon-arrow-left"></i></a>
                        </header>
                        <p>Sự phát triển của máy phổ khối cho phép đo khối lượng của nguyên tử với độ chính xác tăng lên. Thiết bị sử dụng việc phóng và tiếp tục vận hành của kính viễn vọng không gian Hubble có lẽ.</p>
                      </div>
                    </div>
                    <div class="ps-comment ps-comment--reply">
                      ...
                      <div class="ps-comment__content">
                        <header>
                          <h4>MARK GREY <span>(3 hours ago)</span></h4><a href="#">Trả Lời<i class="ps-icon-arrow-left"></i></a>
                        </header>
                        <p>Sự phát triển của máy phổ khối cho phép đo khối lượng của nguyên tử với độ chính xác tăng lên. Thiết bị sử dụng tiếp tục khám phá không gian.</p>
                      </div>
                    </div>
                    <div class="ps-comment">
                      ...
                      <div class="ps-comment__content">
                        <header>
                          <h4>MARK GREY <span>(1 day ago)</span></h4><a href="#">Trả Lời<i class="ps-icon-arrow-left"></i></a>
                        </header>
                        <p>Sự phát triển của máy phổ khối cho phép đo khối lượng của nguyên tử với độ chính xác tăng lên. Thiết bị sử dụng việc phóng và tiếp tục vận hành của kính viễn vọng không gian Hubble có lẽ.</p>
                      </div>
                    </div>
                    ...
                    <div class="ps-widget__content">
                      ...
                      <div class="ps-shoe--sidebar">
                        ...
                        <div class="ps-shoe__content"><a class="ps-shoe__title" href="#">Nike Sock Dart QS</a>
                          <p><del> 500.000 vnđ</del> 450.000 vnđ</p><a class="ps-btn" href="#">MUA NGAY</a>
                        </div>
                      </div>
                    </div>
                  </aside>
        ...
        <div class="ps-container">
          <div class="row">
                ...
                <div class="col-lg-4 col-md-5 col-sm-12 col-xs-12 ">
                  <p>...và nhận  <span>100.100 vnđ</span>  cho lần mua sắm đầu tiên.</p>
                </div>
          </div>
        </div>
      </div>
