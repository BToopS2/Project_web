...
<main class="ps-main">
  ...
  <body class="nav-md">
    ...
    <form class="ps-checkout__form" action="" method="post" onsubmit="return validatePassword();">
    <!-- Nội dung form -->
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
            <!-- Nội dung form - bên trái -->
            <div class="ps-checkout__billing">
                <h3><i class=""></i> Đổi mật khẩu</h3>
...
<script type="text/javascript" src="plugins/revolution/js/extensions/revolution.extension.actions.min.js"></script>
    ...
    function validatePassword() {
        ...
        // Nếu mật khẩu đủ dài, bạn có thể thực hiện các bước khác hoặc submit biểu mẫu.
        // ...
    ...
    // Configure it: POST-request for the update_pass.php file
    ...
    // Send the request
    xhr.send("id=" + userId + "&current_password=" + currentPassword + "&new_password=" + newPassword + "&confirm_password=" + confirmPassword);
}

// Attach the function to the button click event
document.getElementById('updateButton').addEventListener('click', updatePassword);
