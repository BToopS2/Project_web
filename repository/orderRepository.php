<?php
    ...
    class OrderRepository{
        ...
        public function getAll2($userName){
            global $conn;
            $escapedUserName = mysqli_real_escape_string($conn, $userName); // Bảo vệ khỏi SQL injection
            ...
            $sql = "SELECT u.*, c.*, o.*, s.*, o.id AS order_id, c.id AS cart_id
                    ...
                    WHERE u.fullname = '$escapedUserName'";  // Sử dụng tên người dùng để lọc
            return mysqli_query($conn, $sql);
        }
