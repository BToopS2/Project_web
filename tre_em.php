...
<head>
  ...
  <title>Đồ hiệu dành cho trẻ em</title>
  <!-- Fonts-->
    ...
    <div class="ps-products-wrap pt-80 pb-80">
      <div class="ps-products" data-mh="product-listing">
        ...
        <div class="ps-product__columns">
          <div class="girdpro">
            ...
            <?php
            $checkNew = false;
            $listShoe = $shoeRepository->getShoesByCategoryId(3);
      ...
      <div class="ps-sidebar" data-mh="product-listing">
        ...
        <aside class="ps-widget--sidebar ps-widget--category">
          ...
          <div class="ps-widget__content">
            <ul class="ps-list--checked" id="categoryList">
              ...
              <li class="filter" data-brand="váy"><a href="#">Váy (<span id="countVay"></span>)</a></li>
        ...
        <aside class="ps-widget--sidebar ps-widget--category">
          ...
          <div class="ps-widget__content">
            <ul class="ps-list--checked" id="categoryList">
              <li class="filter" data-brand="Trai"><a href="#">Trai</a></li>
              <li class="filter" data-brand="Gái"><a href="#">Gái</a></li>
              <!-- <li class="filter" data-brand="Other"><a href="#">Khác</a></li> -->
            </ul>
          </div>
        </aside>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      filterLinks.forEach(link => {
        link.addEventListener('click', function() {
          ...
          document.getElementById('countVay').textContent = countVay;
        });
      });
    });
  </script>
